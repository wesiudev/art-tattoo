...
export default function TopBar() {
  ...
  return (
    <header>
      {!pathname.includes("tatuaz-grudziadz") && (
        <nav
          className={`${
            pathname.includes("studio-tatuazu-grudziadz-wzory")
              ? "sticky top-0"
              : "fixed"
          } py-3 top-0 left-0 z-[350] border-b-2 border-[#606060] w-full flex flex-row items-center justify-between px-5 lg:px-[8vw] xl:px-[12vw] bg-[#303030]`}
        >
          <Link
            href="/"
