...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_ZAKLEJKI_API_KEY,
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_ZAKLEJKI_AUTH_DOMAIN,
  projectId: process.env.NEXT_PUBLIC_FIREBASE_ZAKLEJKI_PROJECT_ID,
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_ZAKLEJKI_STORAGE_BUCKET,
  messagingSenderId:
    process.env.NEXT_PUBLIC_FIREBASE_ZAKLEJKI_MESSAGING_SENDER_ID,
  appId: process.env.NEXT_PUBLIC_FIREBASE_ZAKLEJKI_APP_ID,
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_ZAKLEJKI_MEASURMENT_ID,
};

const websiteName = process.env.NEXT_PUBLIC_ZAKLEJKI_APP_NAME;

export const app2 = initializeApp(firebaseConfig, "stickerApp");
